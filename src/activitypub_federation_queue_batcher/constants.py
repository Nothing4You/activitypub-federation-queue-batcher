...
BATCH_RECEIVER_ALLOWED_IPS = os.environ.get("BATCH_RECEIVER_ALLOWED_IPS")
BATCH_RECEIVER_TRUSTED_PROXIES = os.environ.get("BATCH_RECEIVER_TRUSTED_PROXIES")
...
INBOX_RECEIVER_ALLOWED_IPS = os.environ.get("INBOX_RECEIVER_ALLOWED_IPS")
INBOX_RECEIVER_TRUSTED_PROXIES = os.environ.get("INBOX_RECEIVER_TRUSTED_PROXIES")
